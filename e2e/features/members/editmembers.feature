Feature: Edit Member
    ...
    Scenario Outline: I verify that members can be added through the add member form
        ...
        When I fill in the form with:
             | name     | surname | b_day     | b_month     | b_year     | address_one       | address_two       | city           | postcode    | country     | start_hour     | start_minute     | member        |
            | <name_2> | Edit      | <b_day_2> | <b_month_2> | <b_year_2> | Test Address Edit | Test Address Edit | Test City Edit | test1n Edit | <countr_2y> | <start_hour_2> | <start_minute_2> | <memberCount> |
        ...
        Then the Member List page is correctly displayed for <memberCount> memmbers
        ...
        Examples:
            ...
            | Ioana | 01    | 11      | 1995   | Canada  | 19         | 35           | Test   | 10      | 02        | 1991     | Andorra   | 11           | 15             | 1           |
